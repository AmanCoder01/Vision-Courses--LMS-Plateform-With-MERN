  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      {step == 1 && <div className="bg-white shadow-md rounded-xl p-8 max-w-md w-full">
        ...
        <div className="text-sm text-center mt-4 cursor-pointer hover:underline" onClick={() => navigate("/login")} >
      ...
      {step == 3 && <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full">
        ...
        {/* Back to login */}
        <div className="text-center text-sm mt-4 cursor-pointer hover:underline" onClick={() => navigate("/login")}>
