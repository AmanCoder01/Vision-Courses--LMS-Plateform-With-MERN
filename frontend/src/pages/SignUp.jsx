...
function SignUp() {
    ...
    useEffect(() => {
        if (userData) {
            // If user already logged in, go back to previous page
        ...
        <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center flex-col gap-3'>
            <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e) => e.preventDefault()}>
                <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3 '>
                 ...
                 <div className='w-[50%] h-[100%] rounded-r-2xl bg-[black] md:flex items-center justify-center flex-col hidden'><img src={logo} className='w-60 shadow-2xl' alt="" />
                                <span className='text-[white] text-2xl'>VISION COURSES</span>
                                </div>
